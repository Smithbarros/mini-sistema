#!bin/bash/
  E='echo -e';e='echo -en';trap "R;exit" 2
    ...
    HEAD(){ for each in $(seq 2 16);do
           ...
           $E "               4º questão                 " ;UNMARK;
           TPUT 2 5
           $E "Elaborar um script que receba um número 
   |como parâmetro e imprima todos os números
   |pares de 0 até o número informado. " ;UNMARK;}
  ...
  ARROW(){ IFS= read -s -n1 key 2>/dev/null >&2
     ...
     M0(){ TPUT  10 12; $e "Abrir a questao 04      ";}
